...
demo = gr.Interface(predict_image_text, gr.Image(), "text",title="Handwritting To Digital Text Convertor",description="Upload an image and get the extracted text.")
demo.launch()
